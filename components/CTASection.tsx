      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            ...
            className="group relative w-full sm:w-auto px-8 py-4 md:px-10 md:py-5 rounded-2xl bg-[#00ffd1] text-black font-bold text-base md:text-lg transition-all duration-500 hover:shadow-[0_0_60px_rgba(0,255,209,0.4)] hover:scale-[1.03] cursor-pointer overflow-hidden"
          >
            {/* Shimmer effect */}
