...
const footerLinks = {
  ...
  Community: ["Twitter", "Instagram", "Facebook", "GitHub"],
        ...
        <div className="flex flex-col lg:flex-row gap-10 md:gap-16 mb-10 md:mb-16">
          ...
          <div className="lg:w-1/3 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="flex gap-3 mt-6 justify-center lg:justify-start">
              {/* Twitter / X */}
              <a
                href="https://x.com/official_usbt"
                target="_blank"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/usbt.official/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl glass flex items-center justify-center text-white/40 hover:text-[#00ffd1] hover:bg-white/[0.06] transition-all duration-300 cursor-pointer"
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/profile.php?id=61587755409227"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl glass flex items-center justify-center text-white/40 hover:text-[#00ffd1] hover:bg-white/[0.06] transition-all duration-300 cursor-pointer"
                aria-label="Facebook"
              ...
              {/* GitHub */}
              <a
                href="https://github.com/official-usbt"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl glass flex items-center justify-center text-white/40 hover:text-[#00ffd1] hover:bg-white/[0.06] transition-all duration-300 cursor-pointer"
                aria-label="GitHub"
                ...
                <ul className="space-y-3">
                  {links.map((link) => {
                    const linkMap: Record<string, string> = {
                      Whitepaper: "/USBT-Whitepaper.pdf",
                      Twitter: "https://x.com/official_usbt",
                      Instagram: "https://www.instagram.com/usbt.official/",
                      Facebook: "https://www.facebook.com/profile.php?id=61587755409227",
                      GitHub: "https://github.com/official-usbt",
                    };
                    ...
                    return (
                      <li key={link}>
                        <a
                          href={href}
                          target={isExternal || link === "Whitepaper" ? "_blank" : undefined}
                          rel={isExternal || link === "Whitepaper" ? "noopener noreferrer" : undefined}
